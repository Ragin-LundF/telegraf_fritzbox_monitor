...
class FritzboxWAN(FritzboxModelInterface):
    ...
    def influx_data(self) -> str:
        ...
        influx_result = InfluxPrint.append(influx_result, "Layer1DownstreamMaxBitRate",
                                           self.max_linked_bitrate_downstream)
        ...
        influx_result = InfluxPrint.append(influx_result, "TransmissionRateDownstream",
                                           self.transmission_rate_downstream)
        influx_result = InfluxPrint.append(influx_result, "TransmissionRateUpstream", self.transmission_rate_upstream)
        influx_result = InfluxPrint.append(influx_result, "ByteReceiveRate", self.current_downstream_rate)
        influx_result = InfluxPrint.append(influx_result, "ByteSendRate", self.current_upstream_rate)
